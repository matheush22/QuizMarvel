...
public class TelaPerguntaNv1 extends JFrame {

	private static final long serialVersionUID = -978171121382335929L;
	private JPanel contentPane;
	private double valorParar;
	private double valorErrar;

	public TelaPerguntaNv1(String[][] pergRespNv1, String[] respostaCorretaNv1, String nomeJogador, String nivelJogo) {
		super("Nível 1 - QuizMarvel");
		...
		JLabel lblValorErrar = new JLabel("0.0");
		...
		JLabel lblValorParar = new JLabel("0.0");
		...
		JLabel lblValorAcertar = new JLabel("0.0");
		...
		btnResponder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				pontuacaoAcertar = Double.parseDouble(lblValorAcertar.getText()) + 100;
				...
				if (!repostaEscolhida.equals(respostaCorretaNv1[numPergunta])) {
				...
				if ((numPergunta == 4) && (repostaEscolhida.equals(respostaCorretaNv1[numPergunta]))) {
					PerguntaExcel perguntaExcel = new PerguntaExcel();
					String[][] perguntasNv2 = null;
					try {
						perguntasNv2 = perguntaExcel.capturarPerguntas(1);
					} catch (Exception e2) {
						e2.printStackTrace();
					}
					String[][] pergNv2Sorteadas = perguntaExcel.sortearPerguntas(perguntasNv2);
					String[] respostaCorretaNv2 = new String[5];
					for (int i = 0; i < pergNv2Sorteadas.length; i++) {
						respostaCorretaNv2[i] = pergNv2Sorteadas[i][2];
					}
					String[][] pergRespNv2Sorteadas = perguntaExcel.sortearPerguntasRespostas(pergNv2Sorteadas);
					TelaPerguntaNv2 telaPerguntaNv2 = new TelaPerguntaNv2(pergRespNv2Sorteadas, respostaCorretaNv2, nomeJogador, "Nível 2");
					telaPerguntaNv2.setVisible(true);
					setVisible(false);
				}
				switch (numPergunta) {
				case 0:
					lblPergunta.setText(pergRespNv1[numPergunta + 1][1]);
					rdbtnResp1.setText(pergRespNv1[numPergunta + 1][2]);
					rdbtnResp2.setText(pergRespNv1[numPergunta + 1][3]);
					rdbtnResp3.setText(pergRespNv1[numPergunta + 1][4]);
					rdbtnResp4.setText(pergRespNv1[numPergunta + 1][5]);
					rdbtnResp1.setSelected(true);
		...
		lblBackground.setIcon(new ImageIcon(QuizMarvelUtil.IMAGEM_NV1));
