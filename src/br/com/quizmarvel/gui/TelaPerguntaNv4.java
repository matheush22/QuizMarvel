...
public class TelaPerguntaNv4 extends JFrame {

	private static final long serialVersionUID = 7307292176783504273L;
	private JPanel contentPane;
	private double valorParar = 50000.0;
	private double valorErrar = 25000.0;

	public TelaPerguntaNv4(String[][] pergRespNv4, String[] respostaCorretaNv4, String nomeJogador, String nivelJogo) {
		super("Nível 4 - QuizMarvel");
		...
		JLabel lblValorErrar = new JLabel("25000.0");
		...
		JLabel lblValorParar = new JLabel("50000.0");
		...
		JLabel lblValorAcertar = new JLabel("100000.0");
		...
		btnResponder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!repostaEscolhida.equals(respostaCorretaNv4[numPergunta])) {
				...
				if ((numPergunta == 4) && (repostaEscolhida.equals(respostaCorretaNv4[numPergunta]))) {
					PerguntaExcel perguntaExcel = new PerguntaExcel();
					String[][] perguntasNv5 = null;
					try {
						perguntasNv5 = perguntaExcel.capturarPerguntas(4);
					} catch (Exception e2) {
						e2.printStackTrace();
					}
					String[][] pergNv5Sorteadas = perguntaExcel.sortearPerguntas(perguntasNv5);
					String[] respostaCorretaNv5 = new String[5];
					for (int i = 0; i < pergNv5Sorteadas.length; i++) {
						respostaCorretaNv5[i] = pergNv5Sorteadas[i][2];
					}
					String[][] pergRespNv5Sorteadas = perguntaExcel.sortearPerguntasRespostas(pergNv5Sorteadas);
					TelaPerguntaNv5 telaPerguntaNv5 = new TelaPerguntaNv5(pergRespNv5Sorteadas, respostaCorretaNv5, nomeJogador, "Nível 5");
					telaPerguntaNv5.setVisible(true);
					setVisible(false);
				}
				switch (numPergunta) {
				case 0:
					lblPergunta.setText(pergRespNv4[numPergunta + 1][1]);
					rdbtnResp1.setText(pergRespNv4[numPergunta + 1][2]);
					rdbtnResp2.setText(pergRespNv4[numPergunta + 1][3]);
					rdbtnResp3.setText(pergRespNv4[numPergunta + 1][4]);
					rdbtnResp4.setText(pergRespNv4[numPergunta + 1][5]);
					rdbtnResp1.setSelected(true);
		...
		lblBackground.setIcon(new ImageIcon(QuizMarvelUtil.IMAGEM_NV4));
