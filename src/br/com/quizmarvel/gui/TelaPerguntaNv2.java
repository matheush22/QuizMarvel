...
public class TelaPerguntaNv2 extends JFrame {

	private static final long serialVersionUID = 3314728620723446145L;
	private JPanel contentPane;
	private double valorParar = 500.0;
	private double valorErrar = 250.0;

	public TelaPerguntaNv2(String[][] pergRespNv2, String[] respostaCorretaNv2, String nomeJogador, String nivelJogo) {
		super("Nível 2 - QuizMarvel");
		...
		JLabel lblValorErrar = new JLabel("250.0");
		...
		JLabel lblValorParar = new JLabel("500.0");
		...
		JLabel lblValorAcertar = new JLabel("1000.0");
		...
		btnResponder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				pontuacaoAcertar = Double.parseDouble(lblValorAcertar.getText()) + 1000;
				...
				if (!repostaEscolhida.equals(respostaCorretaNv2[numPergunta])) {
				...
				if ((numPergunta == 4) && (repostaEscolhida.equals(respostaCorretaNv2[numPergunta]))) {
					PerguntaExcel perguntaExcel = new PerguntaExcel();
					String[][] perguntasNv3 = null;
					try {
						perguntasNv3 = perguntaExcel.capturarPerguntas(2);
					} catch (Exception e2) {
						e2.printStackTrace();
					}
					String[][] pergNv3Sorteadas = perguntaExcel.sortearPerguntas(perguntasNv3);
					String[] respostaCorretaNv3 = new String[5];
					for (int i = 0; i < pergNv3Sorteadas.length; i++) {
						respostaCorretaNv3[i] = pergNv3Sorteadas[i][2];
					}
					String[][] pergRespNv3Sorteadas = perguntaExcel.sortearPerguntasRespostas(pergNv3Sorteadas);
					TelaPerguntaNv3 telaPerguntaNv3 = new TelaPerguntaNv3(pergRespNv3Sorteadas, respostaCorretaNv3, nomeJogador, "Nível 3");
					telaPerguntaNv3.setVisible(true);
					setVisible(false);
				}
				switch (numPergunta) {
				case 0:
					lblPergunta.setText(pergRespNv2[numPergunta + 1][1]);
					rdbtnResp1.setText(pergRespNv2[numPergunta + 1][2]);
					rdbtnResp2.setText(pergRespNv2[numPergunta + 1][3]);
					rdbtnResp3.setText(pergRespNv2[numPergunta + 1][4]);
					rdbtnResp4.setText(pergRespNv2[numPergunta + 1][5]);
					rdbtnResp1.setSelected(true);
		...
		lblBackground.setIcon(new ImageIcon(QuizMarvelUtil.IMAGEM_NV2));
